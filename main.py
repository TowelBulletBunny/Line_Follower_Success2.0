...
def get_line_error():
    ...
    # THRESH_BINARY_INV turns dark shadows into white patches
    ...
    # --- NEW: DISPLAY PIXEL COUNT ON CAMERA VIEW ---
    # This draws the number in yellow on the top left of the small camera window
    cv2.putText(debug_view, f"P: {int(pixel_count)}", (5, 15), 
    ...
    if pixel_count > 10000:
        error = "FINISH"
    elif 500 < pixel_count < 1500: # Adjust 5500 based on what you see in the 'P' value
        cx = int(M['m10'] / M['m00'])
